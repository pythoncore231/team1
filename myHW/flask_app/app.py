...
def scheduler_get():
    ...
    return render_template('scheduler.html', schedulers=schedulers, form=form, groups=groups, lessons=lessons,
                           rooms=rooms)
...
def scheduler_put(id):
    ...
    if scheduler:
        ...
        return render_template('scheduler_update.html', schedulers=schedulers, form=form, groups=groups,
                               lessons=lessons, rooms=rooms)
    return redirect('/scheduler')
